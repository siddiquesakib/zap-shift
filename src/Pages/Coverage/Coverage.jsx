...
/**
 * 1. import 'leaflet/dist/leaflet.css' //eita must likhte hbe
 * 2. react-leaflet.js.org . // install korte hbe
 * 3. <MapContainer center={position} zoom={13} scrollWheelZoom={false}>
 * 
 * 4.  <TileLayer
            attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
            url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"/>
 * 5. main div e and MapContainer e same higth dite hbe
 */
